/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3848edfc9b6fc777e7ca3985c218059f)
// Runtime types generated with workerd@1.20251011.0 2025-01-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ChatRoom" | "BoardRoom" | "ShipForge" | "EconomyRegionDO";
	}
	interface Env {
		FORGE_DEV_MODE: string;
		FORGE_LOCKED: string;
		CHAT_ROOM: DurableObjectNamespace<import("./src/index").ChatRoom>;
		BOARD_ROOM: DurableObjectNamespace<import("./src/index").BoardRoom>;
		SHIP_FORGE: DurableObjectNamespace<import("./src/index").ShipForge>;
		ECONOMY_REGION: DurableObjectNamespace<import("./src/index").EconomyRegionDO>;
